...
task_t collect_controller_input(struct ControllerConfig arg[static 1])
{
    return task_create($(void, (struct ControllerConfig controller[static 1]) {
        ...
        digital_threads[0] = task_create($(void, (struct Controller_DigitalActionGroup dgroup[static 1]) {
            while (true)
        ...
        digital_threads[1] = task_create($(void, (struct Controller_DigitalActionGroup dgroup[static 1]) {
            while (true)
        ...
        digital_threads[2] = task_create($(void, (struct Controller_DigitalActionGroup dgroup[static 1]) {
            while (true)
