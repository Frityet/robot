 ...
 *
 * \note ControllerConfig text setting is currently in beta, so continuous, fast
 ...
 *
 * \note ControllerConfig rumble activation is currently in beta, so continuous, fast
 * updates will not work well.
 *
 * This function uses the following values of errno when an error state is
 * reached:
